...
async def test_initialize_devices() -> None:
    ...
    with patch(
        "custom_components.onlycat._retrieve_device_transit_policies"
    ) as mock_retrieve_device_transit_policies:
    ...
    assert mock_retrieve_device_transit_policies.call_count == 1
